...
/** Token Manager. */
public class JavaDBNetParserTokenManager implements JavaDBNetParserConstants
{
...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 123:
         return jjStartNfaWithStates_0(0, 82, 31);
      case 124:
         jjmatchedKind = 110;
...
static final int[] jjnextStates = {
   34, 35, 40, 41, 44, 45, 8, 53, 64, 65, 19, 20, 22, 10, 12, 49, 
   51, 2, 54, 55, 57, 4, 5, 8, 19, 20, 24, 22, 31, 32, 36, 37, 
   8, 44, 45, 8, 60, 61, 63, 67, 68, 70, 6, 7, 13, 14, 16, 21, 
   23, 25, 38, 39, 42, 43, 46, 47, 
};

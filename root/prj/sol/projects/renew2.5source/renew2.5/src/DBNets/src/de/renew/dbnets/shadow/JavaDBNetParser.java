...
public class JavaDBNetParser implements InscriptionParser, JavaDBNetParserConstants {
...
// Thoroughly parse the declaration node.
  final public ParsedDeclarationNode DeclarationNode() throws ParseException {
  setDeclarationNode(new ParsedDeclarationNode());

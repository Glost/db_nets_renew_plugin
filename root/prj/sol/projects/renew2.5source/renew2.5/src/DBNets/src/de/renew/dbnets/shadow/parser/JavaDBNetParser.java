...
// Thoroughly parse the declaration node.
  final public ParsedDBNetDeclarationNode DeclarationNode() throws ParseException {
  ...
  final public ParsedImportDecl ImportDeclaration() throws ParseException {
  String name;
  boolean star=false;
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new ParsedImportDecl(name,star);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public void VariableNamePart(Class<?> clazz) throws ParseException {
  Token t;
 ...
 * by semicolons.
 **/
  final public Collection<Object> PlaceInscription() throws ParseException {
  Object single;
 ...
 **/
  final public Object SinglePlaceInscription() throws ParseException {
  Class<?> type;
...
//      }
      ...
      {if (true) return JavaHelper.makeExpression(vector,null,decl,errToken,refactoring);}
    } else if (jj_2_14(3)) {
      expr = Expression();
      {if (true) return expr;}
    } else if (jj_2_15(3)) {
      queryCall = QueryCall();
      {if (true) return queryCall;}
    } else if (jj_2_16(3)) {
      viewPlacePerformanceAnalysisInfo = ViewPlacePerformanceAnalysisInfo();
      {if (true) return viewPlacePerformanceAnalysisInfo;}
    } else {
      jj_consume_token(-1);
 ...
 **/
  final public Collection<TransitionInscription> TransitionInscription(boolean create, Transition transition) throws ParseException {
 ...
 *                (they are parsed, but not evaluated)
 **/
  final public Collection<TransitionInscription> SingleTransitionInscription(boolean create, Transition transition) throws ParseException {
...
/**
   ...
   */
  final public TransitionInscription UplinkInscription() throws ParseException {
  Token t;
  Token colon, end;
 ...
 **/
  final public Collection<TransitionInscription> CreationInscription(boolean create, Transition transition) throws ParseException {
  Token varT;
  Token netT;
  LocalVariable local;
  Class<?> type;
  ...
  Token errToken;
    ...
    if (create) {
      ...
      if (args==null) {
        {if (true) return Collections.singleton(createInscr);}
      } else {
        channelInscr=new DownlinkInscription("new",
          JavaHelper.makeGuardedTupleExpression(args),
          new VariableExpression(type,local),
          false, transition);
        {if (true) return Arrays.asList(new TransitionInscription[]{createInscr,channelInscr});}
      }
  ...
  final public TransitionInscription DownlinkInscription(Transition transition) throws ParseException {
  ...
  final public TransitionInscription GuardInscription(Transition transition) throws ParseException {
  TypedExpression expr;
    ...
    {if (true) return new de.renew.net.inscription.GuardInscription(expr.getExpression());}
    throw new Error("Missing return statement in function");
  }

  final public TransitionInscription ManualInscription(Transition transition) throws ParseException {
    jj_consume_token(MANUAL);
    {if (true) return de.renew.net.ManualInscription.getInstance();}
    throw new Error("Missing return statement in function");
  }

  final public TransitionInscription ActionInscription(Transition transition) throws ParseException {
  ...
  TypedExpression expr;
    ...
    expr = Expression();
    if (isAction) {
      {if (true) return new ActionInscription(expr.getExpression(), transition);}
    } else {
      {if (true) return new ExpressionInscription(expr.getExpression());}
    }
    throw new Error("Missing return statement in function");
  }

  final public ChannelInscription tryParseChannelInscription() throws ParseException {
  ...
  Vector<?> args;
    ...
    jj_consume_token(RPAREN);
    jj_consume_token(0);
    {if (true) return new ChannelInscription(isUplink,t.image,args.size());}
    throw new Error("Missing return statement in function");
  }

  final public Collection<TimedExpression> ArcInscription() throws ParseException {
  ...
  final public TimedExpression SingleArcInscription() throws ParseException {
  TypedExpression expr;
  TypedExpression time=null;
    ...
    if (jj_2_37(3)) {
     ...
     {if (true) return new TimedExpression(expr,time);}
    throw new Error("Missing return statement in function");
  }

  final public TypedExpression VariableInscription() throws ParseException {
  Token t;
    t = jj_consume_token(IDENTIFIER);
    if (jj_2_38(3)) {
      jj_consume_token(SEMICOLON);
    ...
    jj_consume_token(0);
    {if (true) return JavaHelper.makeSinglePartExpression(
 ...
 *********************************/
  final public JdbcConnection JdbcConnection() throws ParseException {
  Token t;
  String jdbcUrl;
    t = jj_consume_token(DBN_JDBC_URL);
    jdbcUrl = MultilineString();
    {if (true) return new JdbcConnection(jdbcUrl);}
    throw new Error("Missing return statement in function");
  }

  final public DatabaseSchemaDeclaration DatabaseSchemaDeclaration() throws ParseException {
  Token t;
  String ddlQueryString;
    t = jj_consume_token(DBN_DDL);
    ddlQueryString = MultilineString();
    {if (true) return new DatabaseSchemaDeclaration(ddlQueryString);}
    throw new Error("Missing return statement in function");
  }

  final public Query QueryDeclaration() throws ParseException {
  Token t;
  String name;
  String queryString;
    ...
    queryString = MultilineString();
      {if (true) return new Query(name, queryString);}
    throw new Error("Missing return statement in function");
  }

  final public Action ActionDeclaration() throws ParseException {
  Token t;
  String name;
  ...
  Collection<EditedFact> deletedFacts;
    ...
    jj_consume_token(RBRACE);
      {if (true) return new Action(name, params, addedFacts, deletedFacts);}
    throw new Error("Missing return statement in function");
  }

  final public java.util.List<String> ActionParams() throws ParseException {
  String param;
  ...
  final public Collection<EditedFact> EditedFacts() throws ParseException {
  ...
  Collection<EditedFact> editedFacts = new ArrayList<EditedFact>();
    ...
    jj_consume_token(RBRACE);
        {if (true) return editedFacts;}
    throw new Error("Missing return statement in function");
  }

  final public EditedFact EditedFact() throws ParseException {
  String relationName;
  String columnName;
  Object param;
  Map<String, Object> columnsToParams = new HashMap<String, Object>();
    ...
    jj_consume_token(RPAREN);
    {if (true) return new EditedFact(relationName, columnsToParams);}
    throw new Error("Missing return statement in function");
  }
  ...
  String queryName;
    ...
    if (query.isPresent()) {
        {if (true) return new QueryCall(query.get());}
    } else {
  ...
  final public ActionCall ActionCall() throws ParseException {
  Token t;
  String actionName;
  Object param;
  java.util.List<Object> params = new ArrayList<Object>();
    ...
    if (action.isPresent() && action.get().getParams().size() == params.size()) {
        {if (true) return new ActionCall(action.get(), params);}
    } else {
  ...
  final public ViewPlacePerformanceAnalysisInfo ViewPlacePerformanceAnalysisInfo() throws ParseException {
  String idColumnName;
  String sendingTimeColumnName;
  String requestMessageQueryName;
  int maxDelay;
    jj_consume_token(DBN_PA);
    jj_consume_token(COLON);
    jj_consume_token(LBRACE);
    jj_consume_token(DBN_PA_ID_COL);
    jj_consume_token(COLON);
    idColumnName = Name();
    jj_consume_token(COMMA);
    jj_consume_token(DBN_PA_SEND_TIME_COL);
    jj_consume_token(COLON);
    sendingTimeColumnName = Name();
    jj_consume_token(COMMA);
    ...
    jj_consume_token(RBRACE);
        {if (true) return new ViewPlacePerformanceAnalysisInfo(
                idColumnName,
  ...
  String integerString;
    t = jj_consume_token(INTEGER_LITERAL);
      ...
      try {
          {if (true) return Integer.parseInt(integerString);}
  ...
  final public Object LiteralObject() throws ParseException {
  TypedExpression typedExpression;
    typedExpression = Literal();
    {if (true) return new Variable(((ConstantExpression) typedExpression.getExpression()).getConstant(), null);}
    throw new Error("Missing return statement in function");
  }

  final public String MultilineString() throws ParseException {
  Token t;
  StringBuffer s=new StringBuffer();
    t = jj_consume_token(MULTILINE_STRING);
    s.append(t.image);
    {if (true) return s.toString().replace("<{", "").replace("}>", "");}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public Class<?> ClassType() throws ParseException {
  Token errToken;
  String name;
  Object obj;
    errToken=token;
...
/**
   ...
   * @throws ParseException
   */
  final public Class<?> NonArrayType() throws ParseException {
  Class<?> clazz=null;
    if (jj_2_55(3)) {
      clazz = PrimitiveType();
    } else if (jj_2_56(3)) {
  ...
  final public Class<?> Type() throws ParseException {
  Class<?> clazz;
    clazz = NonArrayType();
    label_14:
    while (true) {
  ...
  final public Class<?> PrimitiveType() throws ParseException {
  Class<?> clazz;
    if (jj_2_58(3)) {
...
/**
   ...
   */
  final public TypedExpression Expression() throws ParseException {
  TypedExpression expr;
  ...
  final public TypedExpression Assignment() throws ParseException {
  Token errToken;
  Vector<PrimaryPart> vector;
  ...
  TypedExpression right;
    if (jj_2_69(2147483647)) {
      ...
      right = Expression();
    if (inAction) {
      {if (true) return JavaHelper.makeExpression(vector,right,decl,errToken.next,refactoring);}
    } else {
      {if (true) return JavaHelper.makeEqualityAssertion(
    ...
    if (inAction) {
      ...
      jj_consume_token(ASSIGN);
      right = Expression();
    {if (true) return JavaHelper.makeEqualityAssertion(left,right,errToken);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public TypedExpression NonAssignmentExpression() throws ParseException {
  TypedExpression expr;
  ...
  final public TypedExpression ConditionalOrExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  ...
  final public TypedExpression ConditionalAndExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
    expr = InclusiveOrExpression();
  ...
  final public TypedExpression InclusiveOrExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  ...
  final public TypedExpression ExclusiveOrExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
    expr = AndExpression();
  ...
  final public TypedExpression AndExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  ...
  final public TypedExpression EqualityExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  Function fun;
  ...
  final public TypedExpression InstanceOfExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  Class<?> clazz;
   t=token;
  ...
  final public TypedExpression RelationalExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  Function fun;
  ...
  final public TypedExpression ShiftExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  Function fun;
  ...
  final public TypedExpression AdditiveExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  ...
  final public TypedExpression MultiplicativeExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  TypedExpression right;
  Function fun;
  ...
  final public TypedExpression UnaryExpression() throws ParseException {
  Token t;
  TypedExpression expr;
  Function fun;
  Class<?> type;
    ...
    {if (true) return new TypedExpression(Boolean.TYPE,
      new CallExpression(Boolean.TYPE,expr.getExpression(),
    ...
    {if (true) return new TypedExpression(type,
  ...
  final public TypedExpression SimpleUnaryExpression() throws ParseException {
  Vector<PrimaryPart> vector;
  TypedExpression expr;
    ...
    {if (true) return expr;}
      ...
      vector = PrimaryExpression();
    {if (true) return JavaHelper.makeExpression(vector,null,decl,null,refactoring);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
...
// but they are there just to indicate that we know about this.
  ...
  final public TypedExpression CastExpression() throws ParseException {
  Token errToken;
  Class<?> clazz;
  TypedExpression expr;
    ...
    {if (true) return JavaHelper.makeExplicitCastExpression(clazz,expr,errToken);}
    throw new Error("Missing return statement in function");
  }
 ...
 * @see PrimaryPart
 **/
  final public Vector<PrimaryPart> PrimaryExpression() throws ParseException {
  PrimaryPart part;
 ...
 * @see PrimaryPart
 **/
  final public PrimaryPart PrimaryPrefix() throws ParseException {
  Token t;
  Token thisToken;
  TypedExpression expr;
  ...
  Class<?> clazz;
    ...
    errToken=token;
      expr = Literal();
    {if (true) return new PrimaryPart(PrimaryPart.EXPR,expr,errToken);}
    } else if (jj_2_118(2147483647)) {
    errToken=token;
      clazz = ClassType();
      jj_consume_token(DOT);
      jj_consume_token(CLASS);
    {if (true) return new PrimaryPart(PrimaryPart.EXPR,
      new TypedExpression(Class.class,
        new ConstantExpression(Class.class,clazz)),errToken);}
    } else if (jj_2_119(3)) {
    errToken=token;
      t = jj_consume_token(IDENTIFIER);
    {if (true) return new PrimaryPart(PrimaryPart.NAME,t.image,errToken);}
    } else if (jj_2_120(3)) {
    errToken=token;
 ...
 * @see PrimaryPart
 **/
  final public PrimaryPart PrimarySuffix() throws ParseException {
  Token t;
  TypedExpression expr;
  Vector<?> vector;
  Token errToken;
    ...
    errToken=token;
      ...
      expr = Expression();
      jj_consume_token(RBRACKET);
    {if (true) return new PrimaryPart(PrimaryPart.ARRAY,expr,errToken);}
    } else if (jj_2_126(3)) {
    errToken=token;
      jj_consume_token(DOT);
      t = jj_consume_token(IDENTIFIER);
    ...
    errToken=token;
      ...
      vector = ArgumentList();
      jj_consume_token(RPAREN);
    {if (true) return new PrimaryPart(PrimaryPart.CALL,vector,errToken);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public TypedExpression Literal() throws ParseException {
  Token t;
  Object obj;
  String s;
  Class<?> type;
...
/**
   ...
   * @throws ParseException
   */
  final public Vector<TypedExpression> ArgumentList() throws ParseException {
  ...
  final public TypedExpression AllocationExpression() throws ParseException {
  Token errToken;
  TypedExpression expr;
  Vector<TypedExpression> vector;
  Class<?> clazz;
    ...
    if (jj_2_137(2147483647)) {
      ...
      vector = ArgumentList();
      jj_consume_token(RPAREN);
      {if (true) return JavaHelper.makeConstructorExpression(clazz,vector,errToken);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
 ...
 */
  final public TypedExpression ArrayDimensions(Class<?> clazz) throws ParseException {
  Token t;
  Vector<TypedExpression> vector=new Vector<TypedExpression>();
  TypedExpression expr;
    label_28:
    ...
    {if (true) return new TypedExpression(clazz,

 ...
 *********************************/
  final public 
DatabaseSchemaDeclaration DatabaseSchemaDeclaration() throws ParseException {Token t;
...
{if ("" != null) return new Action(name, params, addedFacts, deletedFacts);}
  ...
  final public Collection<String> ActionParams() throws ParseException {String param;
...
paramsValues.add(paramValue);
    ...
    jj_consume_token(RPAREN);
{if ("" != null) return new EditedFact(relationName, paramsValues);}
    throw new Error("Missing return statement in function");
  }
  ...
  String queryName;
    ...
    jj_consume_token(COLON);
    queryName = Name();
{if ("" != null) return new QueryCall(queryName);}
    throw new Error("Missing return statement in function");
  }
...
params.add(param);
    ...
    jj_consume_token(RPAREN);
{if ("" != null) return new ActionCall(actionName, params);}
    throw new Error("Missing return statement in function");
  }

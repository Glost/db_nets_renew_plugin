 ...
 *********************************/
  ...
  final public Collection<String> ActionParams() throws ParseException {
  String param;
  ...
  String relationName;
  String paramValue;
  Collection<String> paramsValues = new ArrayList<String>();
    relationName = Name();
    jj_consume_token(LPAREN);
    paramValue = Name();
    ...
    jj_consume_token(RPAREN);
    {if (true) return new EditedFact(relationName, paramsValues);}
    throw new Error("Missing return statement in function");
  }
  ...
  String queryName;
    ...
    jj_consume_token(COLON);
    queryName = Name();
    {if (true) return new QueryCall(queryName);}
    throw new Error("Missing return statement in function");
  }
  ...
  Collection<String> params = new ArrayList<String>();
    ...
    jj_consume_token(RPAREN);
    {if (true) return new ActionCall(actionName, params);}
    throw new Error("Missing return statement in function");
  }

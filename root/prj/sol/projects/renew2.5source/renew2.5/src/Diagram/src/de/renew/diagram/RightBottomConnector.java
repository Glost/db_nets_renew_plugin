 ...
 */
public class RightBottomConnector extends AbstractConnector {
    public RightBottomConnector() { // only used for Storable implementation
    }

    public RightBottomConnector(Figure owner) {
        super(owner);
    }

 ...
 *
 */
public class VSplitFigure extends TailFigure implements ISplitFigure {
    public static org.apache.log4j.Logger logger = org.apache.log4j.Logger
                                                       .getLogger(VSplitFigure.class);
    ...
    public void findAndNotifyDChildren() {
        ...
        while (it.hasNext()) {
            ...
            if (connector instanceof LeftConnector
                        || connector instanceof RightConnector) {
                addDChild(dChild);

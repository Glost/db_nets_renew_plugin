 ...
 */
public class FigureChangeEventMulticaster extends AWTEventMulticaster
    ...
    public void figureHandlesChanged(FigureChangeEvent e) {
        ((FigureChangeListener) a).figureHandlesChanged(e);
        ((FigureChangeListener) b).figureHandlesChanged(e);
    }
